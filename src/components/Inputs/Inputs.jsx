...
const Inputs = ({
  ...
  const loadMoreCities = () => {
    setDisplayedCities(displayedCities + 5);
  };

  return (
    <>
      <div className="flex mx-auto max-w-screen-md mt-7 py-2 px-2.5 bg-gradient-to-br from-cyan-700 to-blue-700 h-fit shadow-xl shadow-gray-400">
        <div className="flex flex-row w-4/4 items-center justify-center space-x-4">
          <h1 className="text-white ml-4">What's the Weather </h1>
          <input
            value={city}
      ...
      <div className="dropdown">
        ...
        {cities.length > displayedCities && (
          <button
            onClick={loadMoreCities}
            className="text-green-700 pt-4 text-3xl font-medium"
          >
            {isSearchSelected ? "Load More" : null}
          </button>
        )}
      </div>
    </>
